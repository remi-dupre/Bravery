...
var api = {
    champion : {
        ...
        adresse : "https://global.api.pvp.net/api/lol/static-data/euw/v1.2/champion?locale=fr_FR&champData=allytips,altimages,image,tags&api_key=d19e6095-3a97-4721-b23d-a7710557acb1"
    },
    item : {
        nom : "Items",
...
function chargerApi(onDone = api_after_loaded) {
    /* Charge l'API
